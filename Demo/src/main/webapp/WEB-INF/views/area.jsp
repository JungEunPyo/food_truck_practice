...
<body>
    <nav class="navbar navbar-dark bg-dark" >
     ...
     <div>
      <iframe width="100%" height="800px" src="https://sg.sbiz.or.kr/godo/index.sg" frameborder="1" scrolling="yes" >이 브라우저는 iframe을 지원하지 않습니다</iframe>
     </div>
